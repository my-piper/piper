-- clear
DROP VIEW IF EXISTS pipeline_metrics_outputs_mv;
DROP TABLE IF EXISTS pipeline_metrics_outputs_consumer;
DROP TABLE IF EXISTS pipeline_metrics_outputs;
-- table
...
PARTITION BY toYYYYMM(filledAt)
ORDER BY filledAt 
