-- clear
DROP VIEW IF EXISTS pipeline_usages_mv;
DROP TABLE IF EXISTS pipeline_usages_consumer;
DROP TABLE IF EXISTS pipeline_usages;
-- table
...
PARTITION BY toYYYYMM(processedAt)
